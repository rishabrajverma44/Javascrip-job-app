...
export function Form() {
    ...
    <div id='applicationForm'>
      ...
      <select id="jobType">
        <option value="" disabled ${
          !state.form.jobType ? "selected" : ""
        }>Select job type</option>
        <option value="Remote" ${
          state.form.jobType === "Remote" ? "selected" : ""
        }>Remote</option>
        <option value="Onsite" ${
          state.form.jobType === "Onsite" ? "selected" : ""
        }>Onsite</option>
        <option value="Hybrid" ${
          state.form.jobType === "Hybrid" ? "selected" : ""
        }>Hybrid</option>
      </select>
      ...
      <select id="status" class="form-control">
        ...
        <option value="Hired" ${
          state.form.status === "Hired" ? "selected" : ""
        }>Hired</option>
      </select>
  ...
  [erorCompany, erorJobRole, erorJobType, erorLocation, erorJobStatus].forEach(
    (el) => {
